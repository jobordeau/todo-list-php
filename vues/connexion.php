          ...
          <form method="post" class="form-inline my-2 my-lg-0" style="margin-right:10px;">
              ...
              <?php 
                if(isset($_SESSION['utilisateur'])) 
                    ...
                    echo '
                    <form method="post" class="form-inline my-2 my-lg-0" style="margin-right:10px;">
                        <button name="action" type="submit" value="afficherConnexion" class="btn btn-info my-2 my-sm-0">Se connecter</button>
                    </form>
                    <form method="post" class="form-inline my-2 my-lg-0" style="margin-right:10px;">
                    ...
                    <div class="card-body p-5">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 mb-4">Gérez vos listes privées !</h1>
                            </div>
                            <!-- CONNEXION-->
                            <form method="post">
                                ...
                                <button name="action" type="submit" value="connexion" class="btn btn-primary btn-user btn-block">Connexion</button>
                            </form>
                            <!---->
                            <hr>
                            <form method="post" class="text-center">
                                <button name="action" type="submit" value="afficherInscription" class="btn btn-link">Pas de compte ? Inscrivez-vous.</button>
                            </form>
